...
# Location of arm-none-eabi folder:
SET(ARM_NONE_EABI_DIR $ENV{HOME}/usr/arm_cm3/arm-none-eabi)

SET(CMAKE_SYSTEM_INCLUDE_PATH ${ARM_NONE_EABI_DIR}/include)
SET(CMAKE_SYSTEM_LIBRARY_PATH ${ARM_NONE_EABI_DIR}/lib)
SET(CMAKE_SYSTEM_PROGRAM_PATH ${ARM_NONE_EABI_DIR}/bin )
